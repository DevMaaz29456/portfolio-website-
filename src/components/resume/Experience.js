      ...
      <div className="w-full md:w-1/2">
        ...
        <div className="mt-6 md:mt-14 w-full border-l-[6px] border-l-black border-opacity-30 flex flex-col gap-10">
          <ResumeCard
            ...
            result="Mardan KPK"
            des="Worked on software and web solutions with a focus on quality and innovation."
          />
          <ResumeCard
            title="Web Developer & Partner"
            subTitle="Gojins - (Dec 2023 - 2024)"
            result="STP Mardan"
            des="Specialized in software and digital solutions for modern businesses."
          />
          <ResumeCard
            title="Remote Front-end Developer"
            subTitle="Devsinc - (2024 - Present)"
            result="Lahore"
            des="Contributed to software and web solutions for global business needs."
          />
        </div>
      </div>
      ...
      <div className="w-full md:w-1/2">
        ...
        <div className="mt-6 md:mt-14 w-full border-l-[6px] border-l-black border-opacity-30 flex flex-col gap-10">
          <ResumeCard
            ...
            result="Full Time"
            des="Built responsive web apps using React.js, ensuring functionality and usability."
          />
          <ResumeCard
            title="Freelancer (Web Developer)"
            subTitle="Self-Employed (Ongoing)"
            result="Mardan"
            des="Delivered scalable frontend solutions using React.js and Tailwind CSS."
          />
          <ResumeCard
